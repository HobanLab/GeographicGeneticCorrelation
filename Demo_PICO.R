...
# Uses data files from MacLachlan et al. 2021 to pull in genetic data (as a STRUCTURE input file) 
...
# mtext(text='Geographic coverage (%)', side=1, line=3, cex=1.6)
# mtext(text='Genetic coverage (%)', side=2, line=2.3, cex=1.6, srt=90)
# mylabel = bquote(italic(R)^2 == .(format(PICO_model_rSquared, digits = 3)))
