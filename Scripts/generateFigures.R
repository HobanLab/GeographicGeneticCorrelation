...
# standard selection 
selected <- p1[p1$sampleID %in% c("MER8","CR62","ROV4","CTW2","OKG5"),]
...
# areas measures 
k50 <- terra::expanse(x = km50, unit = "km")
...
# areas measures 
sr5 <- terra::expanse(x = s5, unit = "km")
sr25 <- terra::expanse(x = s25, unit = "km")
sr50 <- terra::expanse(x = s50, unit = "km")
...
# areas measures 
a50 <- terra::expanse(x = r50, unit = "km")
...
# areas measures 
ar5 <- terra::expanse(x = sr5, unit = "km")
ar25 <- terra::expanse(x = sr25, unit = "km")
ar50 <- terra::expanse(x = sr50, unit = "km")
